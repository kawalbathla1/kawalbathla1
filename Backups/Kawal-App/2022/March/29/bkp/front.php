...
// try{
//   $product_create_webhook = $sc->call('GET','/admin/api/'.$SHOPIFY_API_VERSION.'/webhooks.json?address='.$SHOPIFY_DOMAIN_URL.'/webhooks/product_update.php');
//   // print_r($product_create_webhook);
//   $webhook_product_create = array (
//     "webhook" => array (
//     "topic" => "products/update",
//     "address" => $SHOPIFY_DOMAIN_URL.'/webhooks/product_update.php',
//     "format" => "json"
//     )
//   );
//   if (empty($product_create_webhook)) {
//     $web = $sc->call('POST', '/admin/api/'.$SHOPIFY_API_VERSION.'/webhooks.json', $webhook_product_create);
//   }
// }
// catch(Exception $e) {
...
// $product_create_webhooksss = $sc->call('GET','/admin/api/'.$SHOPIFY_API_VERSION.'/webhooks.json');
// echo"<pre>";
// order create webhook
  try{
    $order_create_webhook = $sc->call('GET','/admin/api/'.$SHOPIFY_API_VERSION.'/webhooks.json?address='.$SHOPIFY_DOMAIN_URL.'/webhooks/new_order.php');
    // print_r($order_create_webhook);
    $webhook_order_create = array (
      "webhook" => array (
      "topic" => "orders/create",
      "address" => $SHOPIFY_DOMAIN_URL.'/webhooks/new_order.php',
      "format" => "json"
      )
    );
    if (empty($order_create_webhook)) {
      $web = $sc->call('POST', '/admin/api/'.$SHOPIFY_API_VERSION.'/webhooks.json', $webhook_order_create);
    }
  }
  catch(Exception $e) {
    // echo 'Message: ' .$e->getMessage();
...
// $order_create_webhooks = $sc->call('DEL','/admin/api/'.$SHOPIFY_API_VERSION.'/webhooks/1132510675173.json');
// try{
// // $order_create_webhooks = $sc->call('DEL','/admin/api/'.$SHOPIFY_API_VERSION.'/webhooks/1132510675173.json');
// } catch(Exception $e) {
//   echo $e->getMessage();

$order_create_webhooks = $sc->call('GET','/admin/api/'.$SHOPIFY_API_VERSION.'/webhooks.json');
// print_r($order_create_webhooks);
?> 
