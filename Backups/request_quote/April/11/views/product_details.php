                ...
                <div class="Polaris-Layout">
                    <div class="Polaris-Layout__Section">
                        <div class="Polaris-Card">
                                ...
                                <div>
                                    ...
                                    <span class="Polaris-Choice__Control">
                                        <span class="Polaris-Checkbox">
                                            <input id="PolarisCheckbox3" type="checkbox" class="Polaris-Checkbox__Input manualCard" aria-invalid="false" aria-describedby="PolarisCheckbox3HelpText" role="checkbox" aria-checked="false" value=""><span class="Polaris-Checkbox__Backdrop"></span>
                            ...
                            <div class="Polaris-Card__Section" id="show_manual_card" style="display:none;">
                                <div class="">
                                ...
                                <div>
                                    <label class="Polaris-Choice" for="PolarisCheckbox4">
                                        <span class="Polaris-Choice__Control">
                                            <span class="Polaris-Checkbox">
                                                <!--  -->
                                                <input id="PolarisCheckbox4" type="checkbox" class="Polaris-Checkbox__Input showCard"  aria-invalid="false" aria-describedby="PolarisCheckbox4HelpText" role="checkbox" aria-checked="true" value="" />
                                        ...
                                        <span class="Polaris-Choice__Label">Automate</span>
                                    </label>
                                    <div class="Polaris-Choice__Descriptions"><div class="Polaris-Choice__HelpText" id="PolarisCheckbox4HelpText">"Request for quote" feature is automatically enabled for products that match the set conditions.</div></div>
                                </div>
                            </div>

                            <div class="Polaris-Card__Section" id="show_polaris_card" style="display: none;">
                                ...
                                <div class="mt-5">
                                    <div class="Polaris-FormLayout">
                                        <div class="Polaris-FormLayout--grouped" >
                                            <div class="Polaris-FormLayout__Items" id="content_append">
                                                <div class="Polaris-FormLayout__Item">
                                                    <div class="">
                                                        <div class="Polaris-Select">
                                                            <select id="PolarisSelect2" class="Polaris-Select__Input" >
                                                            ...
                                                            <div class="Polaris-Select__Content">
                                                                <span class="Polaris-Select__SelectedOption" id="selectSet">Product title</span>
                                                    ...
                                                    <div class="">
                                                        <div class="Polaris-Select">
                                                            ...
                                                            <div class="Polaris-Select__Content" aria-hidden="true">
                                                                <span class="Polaris-Select__SelectedOption" id="setSelect1">is not equal to</span>
                                                                <span class="Polaris-Select__Icon">
                                                                    <span class="Polaris-Icon">
                                                                        <svg viewBox="0 0 20 20" class="Polaris-Icon__Svg" focusable="false" aria-hidden="true"><path d="M10 16l-4-4h8l-4 4zm0-12l4 4H6l4-4z"></path></svg>
                                                                    </span>
                                            ...
                                            <div class="Polaris-FormLayout__Items">
                                                <div class="Polaris-FormLayout__Item">
                                                    <button class="Polaris-Button" type="button" id="add_content">
