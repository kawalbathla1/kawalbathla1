            ...
            <div class="Polaris-Card__Section ">
                <div class="Manage_tab_dashboard">
                    ...
                    <div class="polaris_mobile_computer">
                        ...
                        <button class="Polaris-Button save_all_settings  icon_Container" id="ManageSave_settings" type="button"><span class="Polaris-Button__Content" ><span>save</span></span></button>
                    </div>
                </div>
            </div>
        </div>
