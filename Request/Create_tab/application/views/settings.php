                ...
                <div class="Polaris-Card__Section">
                    <div class="back_dashboard">
                        <button type="button" class="Polaris-shopify__Item sd_back_dashboard My_Tab_data" attr_redirect_link= "back_to_dashboard">
                            <!-- <div class="Polaris-shopify__Icon"> -->
                        ...
                        <div class="Polaris-Tabs__Panel tabs_bttn_content settingTab" id="all-customers-content-4" role="tabpanel" aria-labelledby="all-customers-4" tabindex="-1" >
                            ...
                            <div class="Polaris-Card  elements_section"  attr-step= "Contaier-STEP1" >   
                                ...
                                if (!empty($fetch)){ 
                                    ...
                                    foreach ($fetch as $obj){
                                        ...
                                        if($obj->type == "text_area"){
                                          ...
                                          echo' <div class="no_elements Element_tab_area">';
                                          echo'<div class="Polaris-Card__Section hover_mytab add_tab tab_element_accordian" attr-tid='.$obj->id.'" attr-type ="text_area" aria-element="false" attr-value="false">';
                                                  echo'<div class="Polaris-ResourceItem__Media">
                                                  ...
                                                  echo'<div class="Polaris-ResourceItem__Content text_variation">
                                                      <span class="Polaris-TextStyle--variationStrong" name="elementer_'.$obj->id.'[container_title]">'. $obj->tab_title.'</span>
                                                  </div> ';

                                                  echo'<div class="Polaris-ResourceItem__Media tab_element_delete" attr-tid='.$obj->id.'>
                                                  ...
                                                  echo'<div class="Polaris-ResourceItem__Media drag_media_data">
                                          ...
                                          echo'<div class="Polaris-ResourceItem__Container_content Text-discripition_editor element_step_discripition" style="display: none;">';  
                                              echo'<div class="Polaris-Card__Section">';
                                                  echo'<div class="Polaris-Card__Section element_editor">'; 
                                                      echo'<div class="Polaris-FormLayout">';
                                                              echo'<div class="Polaris-FormLayout__Item save_item_field">';
                                                                  echo'<div class="Polaris-Labelled__LabelWrapper">';
                                                                      echo'<div class="Polaris-Label">';
                                                                          echo'<label id="PolarisTextFieldinvoice_title" for="PolarisTextFieldinvoice_titleLabel" class="Polaris-Label__Text">Title</label>';
                                                                      echo'</div>';
                                                                      echo'</div>';
                                                                  echo'<div class="Polaris-Connected">';
                                                                  echo'<div class="Polaris-Connected__Item Polaris-Connected__Item--primary">';
                                                                  echo'<div class="Polaris-TextField">';
                                                                      echo' <input type="text" maxlength="100" name="elementer_'.$obj->id.'[container_title]" id="add_tab_container" placeholder="Enter Title" class="Polaris-TextField__Input title_name_container get_form_data" aria-invalid="false" aria-multiline="false" aria-labelledby="PolarisTextFieldemail_on_billLabel" value='. $obj->tab_title.'>';
                                                                      echo'<div class="Polaris-TextField__Backdrop"></div>';
                                                                      echo'</div>';
                                                                      echo'</div>';
                                                                      echo'</div>';
                                                                      echo'</div>';
                                                                      echo'<div class="Polaris-FormLayout__Item textarea_descripition">';
                                                                      echo'<div class="Polaris-Labelled__LabelWrapper">';
                                                                      echo'<div class="Polaris-Label">';
                                                                      echo'<label id="PolarisTextFieldinvoice_title" for="PolarisTextFieldinvoice_titleLabel" class="Polaris-Label__Text">Text Area</label>';
                                                                      echo'</div>';
                                                                      echo'</div>';
                                                                      echo'<div class="Polaris-Connected">'; 
                                                                      echo'<div class="Polaris-Connected__Item Polaris-Connected__Item--primary"> ';
                                                                    
                                                                      echo'<div class="Polaris-FormLayout__Item Product_tags text_data">';
                                                                     
                                                                      echo'<textarea name="elementer_'.$obj->id.'[container_desc]" class="tiny_text_area " id="featured_container">'. $obj->tab_description.'</textarea>';
                                                                      
                                                                      echo'<input type="hidden" name="elementer_'.$obj->id.'[container_type]" id ="hidden_from_type" value ='. $obj->type.'>';
                                                                      echo'<input type="hidden" name="elementer_'.$obj->id.'[container_id]" id ="hidden_from_id"  value ='. $obj->id.'>';
                                                                   echo'</div>';
                                                                  echo'</div>';
                                                              echo'</div>';
                                                          echo'</div>';
                                ...
                                // show page content:
                                    ...
                                    echo'<div class="no_elements Element_tab_area">';
                                        echo'<div class="Polaris-Card__Section hover_mytab add_tab tab_element_accordian" attr-tid='.$obj->id.'" attr-type ='.$obj->type.' aria-element="false" attr-value="false">';
                                            echo'<div class="Polaris-ResourceItem__Media">
                                                    <svg xmlns="http://www.w3.org/2000/svg" class="Element_tab_header"  style="width: 20px; cursor: pointer;" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M2.5 1A1.5 1.5 0 001 2.5v15A1.5 1.5 0 002.5 19h15a1.5 1.5 0 001.5-1.5v-15A1.5 1.5 0 0017.5 1h-15zM16 5H4v2h12V5zM4 9h12v2H4V9zm6 4H4v2h6v-2z" fill="#5C5F62"></path></svg>';
                                        ...
                                        echo'<div class="Polaris-ResourceItem__Container_content Text-discripition_editor element_step_discripition" attr-type ='.$obj->type.' style="display: none;"> ';  
                                            echo'<div class="Polaris-Card__Section">';
                                                echo'<div class="Polaris-Card__Section element_editor"> ';
                                                    echo'<div class="Polaris-FormLayout">';
                                                        echo' <div class="Polaris-FormLayout__Item save_item_field">';
                                            ...
                                            echo'<div class="Polaris-FormLayout__Item pagecontent_descripition ">';
                                                echo'<div class="Polaris-Labelled__LabelWrapper">';
                                                    echo'<div class="Polaris-Label">
                                        ...
                                        echo'<div class="Polaris-Connected__Item Polaris-Connected__Item--primary"> 
                                            ...
                                            echo'<button type="button" class="Polaris-shopify__Item sd_back_dashboard Edit_page_dashboard" attr-value="true" attr-id="'.$obj->page_id.'">
                                                <span class="Polaris-Icon">
                                        ...
                                        echo'<input type="hidden" name="elementer_'.$obj->id.'[container_selected]" value ="'. $obj->page_select.'">';
                                        echo'<input type="hidden" name="elementer_'.$obj->id.'[container_type]" value = '.$obj->type.'>';
                                        echo'<input type="hidden" name="elementer_'.$obj->id.'[container_page_id]" value = '.$obj->page_id.'>';
                                        echo'<input type="hidden" name="elementer_'.$obj->id.'[container_desc]" value = "none">';
                                        echo'<input type="hidden" name="elementer_'.$obj->id.'[container_id]" value = "'. $obj->id.'">';
                                        echo'</div>';
                                        echo'</div>';
                                        echo'</div> ';
                                        echo'</div>';
                                        ...
                                        <div class="Polaris-ResourceList__ResourceListWrapper">
                                            ...
                                            <ul class="Polaris-ResourceList" aria-live="polite">
                                                                ...
                                                                <div class="Polaris-Card__Section element_editor"> 
                                                                    <div class="Polaris-FormLayout">
                                                                            ...
                                                                            <div class="Polaris-Connected">
                                                                                <div class="Polaris-Connected__Item Polaris-Connected__Item--primary">
                                                                                    <div class="Polaris-TextField">
                                                                                        <input type="text" maxlength="100" name="invoice_title" id="Element_title" placeholder="Enter Title" class="Polaris-TextField__Input title_name" aria-invalid="false" aria-multiline="false" aria-labelledby="PolarisTextFieldemail_on_billLabel" value=''>
                                                                                        <div class="Polaris-TextField__Backdrop"></div>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        ...
                                                                        <div class="title_text_bttn">
                                                                            <button class="Polaris-Button Textarea-Bttn tab_element_save" attr-id="add_textarea_data" attr-action="selected" attr-type="text_area" type="button"><span class="Polaris-Button__Content"><span class="Polaris-Button__Text">Add</span></span></button>
                                                ...
                                                <li class="Polaris-ResourceItem__ListItem" id="LegalContent">   
                                                    ...
                                                    <!-- Legal Content show/hide container -->
                                                    <div class="Polaris-ResourceItem__Container_content" style="display: none;">
                                                ...
                                                <li class="Polaris-ResourceItem__ListItem" id="Page-Container">   
                                                    ...
                                                    <!-- Page Content show/hide container -->
                                                    <div class="Polaris-ResourceItem__Container_content" style="display: none;">
                                                        <div class="Polaris-Card__Section Element_editor element_step_discripition Page-Container_editor" id="tab_pagecontent_">
                                                                ...
                                                                <div class="Polaris-FormLayout__Item page_title_discrition">
                                                                    <!-- get store page body-html -->

                                                                    <div class="Polaris-Select">
                                                                        
                                                                        <select id="content_page_title" class="Polaris-Select__Input page_content_policy Product_tags" name="platform" attr-type="page_content" aria-invalid="false">

                                                                            <option class="page_body_option" selected="selected" aria_element='false'>Select page</option>  
                                                                            <!-- get store page data -->
                                                                            <?php  
                                                                                foreach ($page_list->pages as $item) { ?>
                                                                                <option class="page_content_body" aria_element='true' page-id="<?php echo $item->id; ?>"  value="<?php echo $item->title; ?>"><?php echo $item->title; ?>
                                                                                </option>
                                                                        ...
                                                                        <div class="Polaris-Select__Content Selected_page_btnn" aria-hidden="true">
                                                                            <!-- set value of select option using id -->
                                                                           <span class="Polaris-Select__SelectedOption" id="page_optionSelect">Select page</span> 
                                                                ...
                                                                <div class="Polaris-FormLayout__Item page_content_bttn">
                                                                    <button class="Polaris-Button Textarea-Bttn tab_element_save"  attr-id="add_page_data" attr-action="selected" attr-type="page_content" type="button"><span class="Polaris-Button__Content"><span class="Polaris-Button__Text">Add</span></span></button>
                                                ...
                                                <li class="Polaris-ResourceItem__ListItem"  id="Integration-Container">   
                                                    ...
                                                    <!-- App Integration show/hide container -->
                                                    <div class="Polaris-ResourceItem__Container_content"  style="display: none;">
                            ...
                            <!--------------------------------- INPUT ELEMENTS STEP 2 ----------------------- END---------------------------------------------> 
                        </div>
                        <!-- --------------------------------- ADD TAB  ------------------- END --------------------------------------------->
        

                        <!-- --------------------------------- container [Product] Tab 2 ------------------------------------------------------------------>
            ...
            <div class="Polaris-Card__Section ">
                <div class="Manage_tab_dashboard">
                    ...
                    <div class="polaris_mobile_computer">
                        ...
                        <button class="Polaris-Button save_all_settings  icon_Container" attr_tab_val="tab_create" id="ManageSave_settings" type="button"><span class="Polaris-Button__Content" ><span>save</span></span></button>
                    </div>
                </div>
            </div>
        </div>
